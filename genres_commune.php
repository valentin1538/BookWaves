...
<section id="container">
              ...
              <div class="border-head">
                <h3>GENRES</h3>
                  <form class="barre-recherche" action="" method="GET">
                      <input type="text" name="recherche" placeholder="Rechercher un genre" value="">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            var genres = document.querySelectorAll('.book');

            rechercheInput.addEventListener('input', function () {
                var rechercheValue = this.value.toLowerCase();

                genres.forEach(function (genre) {
                    var nomGenre = genre.querySelector('.genre-link').textContent.toLowerCase();
                    if (nomGenre.includes(rechercheValue)) {
