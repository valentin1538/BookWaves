                        ...
                        <div class="profile-actions">
                            ...
                            <div id="containerx">
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <h2 style='color:white'>Changer la photo de profil</h2>
                                    <input type="file" id="profileImageInput" accept="image/*"
                                        onchange="updateImageUrl()" />
                                    <input type="hidden" id="profileImageUrl" name="profileImageUrl" />
                                    <br>
                                    <input type="submit" name="updateProfileImage" value="Mettre à jour"
                            ...
                            <script>
                                function updateImageUrl() {
                                    ...
                                    var selectedFile = profileImageInput.files[0];
                                    var fileName = selectedFile.name;
                                    document.getElementById('profileImageUrl').value = "../images/PP/" + fileName;
                                }
                            </script>
                        </div>
                    </div>
