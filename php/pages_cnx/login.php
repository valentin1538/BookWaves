...
<body>
    ...
    require('Config.php');
    session_start();
    $source = isset($_GET['source']) ? $_GET['source'] : 'Inconnu';
    echo '<p>Page source : '.htmlspecialchars($source).'</p>';
    ...
    <div id="container">
        <form class="box" action="" method="post" name="login">
            ...
            <h3 class="box-register">Vous pouvez aussi vous <a href="register.php" style='color:skyblue'> inscrire</a>
            </h3>
