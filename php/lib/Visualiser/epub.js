(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else root["ePub"] = factory(root["xmldom"], root["jszip"]);
})(
  this,
  function (__WEBPACK_EXTERNAL_MODULE_16__, __WEBPACK_EXTERNAL_MODULE_68__) {
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          function prefixed(unprefixed) {
            ...
            if (
              ...
              typeof document.body.style[unprefixed] != "undefined"
            ) {
              return unprefixed;
            }
            ...
            for (var i = 0; i < length; i++) {
              if (
                typeof document.body.style[vendors[i] + upper] != "undefined"
              ) {
          ...
          var RangeObject = (exports.RangeObject = (function () {
            ...
            _createClass(RangeObject, [
              ...
              },
              {
                ...
                value: function _commonAncestorContainer(
                  startContainer,
                  endContainer
                ) {
                  var startParents = parents(
...
*/
          ...
          var EpubCFI = (function () {
            function EpubCFI(cfiFrom, base, ignoreClass) {
              ...
              if (typeof base === "string") {
                ...
                (typeof base === "undefined" ? "undefined" : _typeof(base)) ===
                  "object" &&
                base.steps
              ) {
                this.base = base;
            ...
            _createClass(EpubCFI, [
              {
                ...
                value: function checkType(cfi) {
                  if (this.isCfiString(cfi)) {
                    ...
                    (typeof cfi === "undefined"
                      ? "undefined"
                      : _typeof(cfi)) === "object" &&
                    ((0, _core.type)(cfi) === "Range" ||
              ...
              },
              {
                ...
                value: function pathTo(node, offset, ignoreClass) {
                  ...
                  if (offset != null && offset >= 0) {
                    ...
                    if (
                      segment.steps[segment.steps.length - 1].type != "text"
                    ) {
                      segment.steps.push({
                        type: "text",
                        index: 0,
              ...
              },
              {
                ...
                value: function fromRange(range, base, ignoreClass) {
                  ...
                  if (ignoreClass) {
                    ...
                    needsIgnoring =
                      start.ownerDocument.querySelector("." + ignoreClass) !=
                      null;
                  }
                  ...
                  if (range.collapsed) {
                    ...
                    for (i = 0; i < len; i++) {
                      if (
                        this.equalStep(cfi.start.steps[i], cfi.end.steps[i])
                      ) {
                        if (i === len - 1) {
                    ...
                    cfi.start.steps = cfi.start.steps.slice(
                      cfi.path.steps.length
                    );
              ...
              },
              {
                ...
                value: function filter(anchor, ignoreClass) {
                  ...
                  if (needsIgnoring && isText) {
                    ...
                    if (
                      previousSibling &&
                      previousSibling.nodeType === TEXT_NODE
                    ) {
                ...
                value: function patchOffset(anchor, offset, ignoreClass) {
                  ...
                  while (curr.previousSibling) {
                    if (curr.previousSibling.nodeType === ELEMENT_NODE) {
                      ...
                      if (
                        curr.previousSibling.classList.contains(ignoreClass)
                      ) {
  ...
  */
                  ...
                  for (i = 0; i < len; i++) {
                    ...
                    if (step.type === "element") {
                      ...
                      if (step.id) {
                        ...
                        children =
                          container.children ||
                          (0, _core.findChildren)(container);
              ...
              },
              {
                ...
                value: function generateChapterComponent(
                  _spineNodeIndex,
                  _pos,
                  id
                ) {
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          var DOM_EVENTS = (exports.DOM_EVENTS = [
            "keydown",
            "keyup",
            "keypressed",
            "mouseup",
            ...
            _createClass(Url, [
              ...
              },
              {
                ...
                value: function resolve(what) {
                  ...
                  fullpath = _pathWebpack2.default.resolve(
                    this.directory,
                    what
                  );
              ...
              [
                ...
                },
                {
                  ...
                  value: function viewport(options) {
                    ...
                    var $viewport = this.document.querySelector(
                      "meta[name='viewport']"
                    );
                    var parsed = {
                      width: undefined,
                    ...
                    if ($viewport && $viewport.hasAttribute("content")) {
                      ...
                      var _scale2 = content.match(
                        /initial-scale\s*=\s*([^,]*)/
                      );
                      var _minimum2 = content.match(
                        /minimum-scale\s*=\s*([^,]*)/
                      );
                      var _maximum2 = content.match(
                        /maximum-scale\s*=\s*([^,]*)/
                      );
                      var _scalable2 = content.match(
                        /user-scalable\s*=\s*([^,]*)/
                      );
                ...
                },
                {
                  ...
                  value: function resizeListeners() {
                    ...
                    this.expanding = setTimeout(
                      this.resizeListeners.bind(this),
                      350
                    );
                  },
                  ...
                  value: function mediaQueryListeners() {
                    ...
                    for (var i = 0; i < sheets.length; i += 1) {
                      ...
                      for (var j = 0; j < rules.length; j += 1) {
                        ...
                        if (rules[j].media) {
                          var mql = this.window.matchMedia(
                            rules[j].media.mediaText
                          );
                ...
                },
                {
                  ...
                  value: function locationOf(target, ignoreClass) {
                    ...
                    if (this.epubcfi.isCfiString(target)) {
                      var range = new _epubcfi2.default(target).toRange(
                        this.document,
                        ignoreClass
                      );
                          ...
                          if (isWebkit) {
                            ...
                            try {
                              if (container.nodeType === ELEMENT_NODE) {
                                ...
                                position =
                                  container.parentNode.getBoundingClientRect();
                              }
                            } catch (e) {
                ...
                },
                {
                  ...
                  value: function addStylesheetRules(rules) {
                    ...
                    if (
                      Object.prototype.toString.call(rules) === "[object Array]"
                    ) {
                      for (var i = 0, rl = rules.length; i < rl; i++) {
                        ...
                        if (
                          Object.prototype.toString.call(rule[1][0]) ===
                          "[object Array]"
                        ) {
                          rule = rule[1];
                          j = 0;
                  ...
                  value: function triggerSelectedEvent(selection) {
                    ...
                    if (selection && selection.rangeCount > 0) {
                      ...
                      if (!range.collapsed) {
                        ...
                        cfirange = new _epubcfi2.default(
                          range,
                          this.cfiBase
                        ).toString();
                        this.emit(
                          _constants.EVENTS.CONTENTS.SELECTED,
                          cfirange
                        );
                        this.emit(
                          _constants.EVENTS.CONTENTS.SELECTED_RANGE,
                          range
                        );
                      }
                    }
                ...
                },
                {
                  ...
                  value: function linksHandler() {
                    ...
                    (0, _replacements.replaceLinks)(
                      this.content,
                      function (href) {
                        _this2.emit(
                          _constants.EVENTS.CONTENTS.LINK_CLICKED,
                          href
                        );
                      }
                    );
                ...
                },
                {
                  ...
                  value: function layoutStyle(style) {
                    if (style) {
                      ...
                      navigator.epubReadingSystem.layoutStyle =
                        this._layoutStyle;
                    }
            ...
            _createClass(DefaultViewManager, [
              {
                ...
                value: function render(element, size) {
                  ...
                  this.stage.onOrientationChange(
   ...
   */
              ...
              },
              {
                ...
                value: function moveTo(offset) {
                  ...
                  if (!this.isPaginated) {
                    ...
                    distX =
                      Math.floor(offset.left / this.layout.delta) *
                      this.layout.delta;

                    if (
                      distX + this.layout.delta >
              ...
              },
              {
                ...
                value: function scrolledLocation() {
                  ...
                  var sections = visible.map(function (view) {
                    ...
                    var totalPages = _this4.layout.count(
                      height,
                      pageHeight
                    ).pages;
                    ...
                    var mapping = _this4.mapping.page(
                      view.contents,
              ...
              },
              {
                ...
                value: function paginatedLocation() {
                  ...
                  var sections = visible.map(function (view) {
                    ...
                    var mapping = _this5.mapping.page(
                      view.contents,
                      view.section.cfiBase,
                      start,
                      end
              ...
              },
              {
                ...
                value: function setLayout(layout) {
                  ...
                  this.mapping = new _mapping2.default(
                    layout.props,
            ...
            _createClass(Rendition, [
              ...
              },
              {
                ...
                value: function start() {
                  if (!this.manager) {
                    this.ViewManager = this.requireManager(
                  ...
                  this.manager.on(
                    _constants.EVENTS.MANAGERS.ADDED,
                    this.afterDisplayed.bind(this)
                  );
                  this.manager.on(
                    _constants.EVENTS.MANAGERS.REMOVED,
                    this.afterRemoved.bind(this)
                  );

                  // Listen for resizing
                  this.manager.on(
                    _constants.EVENTS.MANAGERS.RESIZED,
                  ...
                  this.manager.on(
                    _constants.EVENTS.MANAGERS.SCROLLED,
              ...
              },
              {
                ...
                value: function _display(target) {
                  ...
                  if (
                    ...
                    ((0, _core.isFloat)(target) || target === "1.0") // Handle 1.0
                  ) {
                  ...
                  this.manager.display(section, target).then(
                    function () {
                       ...
                       */
                      _this.emit(
                        _constants.EVENTS.RENDITION.DISPLAYED,
                        section
                      );
                    ...
                    function (err) {
                       ...
                       */
                      _this.emit(
                        _constants.EVENTS.RENDITION.DISPLAY_ERROR,
                        err
                      );
                    }
                  );
  ...
  */
              ...
              },
              {
                ...
                value: function afterDisplayed(view) {
                  ...
                  view.on(
                    _constants.EVENTS.VIEWS.MARK_CLICKED,
                    function (cfiRange, data) {
                  ...
                  this.hooks.render.trigger(view, this).then(function () {
                    if (view.contents) {
                      _this2.hooks.content
                        .trigger(view.contents, _this2)
                        .then(function () {
                          /**
                           ...
                           */
                          _this2.emit(
                            _constants.EVENTS.RENDITION.RENDERED,
                            view.section,
                            view
                          );
                        });
              ...
              },
              {
                ...
                value: function afterRemoved(view) {
                  ...
                  this.hooks.unloaded.trigger(view, this).then(function () {
                     ...
                     */
                    _this3.emit(
                      _constants.EVENTS.RENDITION.REMOVED,
                      view.section,
                      view
                    );
                  });
              ...
              },
              {
                ...
                value: function onOrientationChange(orientation) {
                   ...
                   */
                  this.emit(
                    _constants.EVENTS.RENDITION.ORIENTATION_CHANGE,
                    orientation
                  );
                },
              ...
              },
              {
                ...
                value: function determineLayoutProperties(metadata) {
                  var properties;
                  var layout =
                    this.settings.layout || metadata.layout || "reflowable";
                  var spread =
                    this.settings.spread || metadata.spread || "auto";
                  var orientation =
              ...
              },
              {
                ...
                value: function layout(settings) {
                  ...
                  if (settings) {
                    ...
                    this._layout.on(
                      _constants.EVENTS.LAYOUT.UPDATED,
                      function (props, changed) {
                        _this4.emit(
                          _constants.EVENTS.RENDITION.LAYOUT,
                          props,
                          changed
                        );
                      }
                          ...
                          if (
                            ...
                            location.then(
                              function (result) {
                                ...
                                this.emit(
                                  _constants.EVENTS.RENDITION.LOCATION_CHANGED,
                                  {
                                ...
                                this.emit(
                                  _constants.EVENTS.RENDITION.RELOCATED,
                                  this.location
                                );
                              }.bind(this)
                            );
              ...
              },
              {
                ...
                value: function located(location) {
                  ...
                  var locationStart = this.book.locations.locationFromCfi(
                    start.mapping.start
                  );
                  var locationEnd = this.book.locations.locationFromCfi(
                    end.mapping.end
                  );
                  ...
                  var pageStart = this.book.pageList.pageFromCfi(
                    start.mapping.start
                  );
              ...
              },
              {
                ...
                value: function triggerSelectedEvent(cfirange, contents) {
                   ...
                   */
                  this.emit(
                    _constants.EVENTS.RENDITION.SELECTED,
                    cfirange,
                    contents
                  );
                },
              ...
              },
              {
                ...
                value: function triggerMarkEvent(cfiRange, data, contents) {
                   ...
                   */
                  this.emit(
                    _constants.EVENTS.RENDITION.MARK_CLICKED,
                    cfiRange,
                    data,
                    contents
                  );
                    ...
                    img: {
                      "max-width":
                        (this._layout.columnWidth
                          ? this._layout.columnWidth + "px"
                          : "100%") + "!important",
                      "max-height":
                        (this._layout.height
                          ? this._layout.height * 0.6 + "px"
                          : "60%") + "!important",
                      "object-fit": "contain",
            ...
            _createClass(Mapping, [
              {
                ...
                value: function section(view) {
                  ...
                  var map = this.rangeListToCfiList(
                    view.section.cfiBase,
                    ranges
                  );
              ...
              },
              {
                ...
                value: function page(contents, cfiBase, start, end) {
                  ...
                  if (this._dev === true) {
                    ...
                    var startRange = new _epubcfi2.default(
                      result.start
                    ).toRange(doc);
                    var endRange = new _epubcfi2.default(result.end).toRange(
                      doc
                    );
              ...
              },
              {
                ...
                value: function findRanges(view) {
                  ...
                  var spreads = Math.ceil(
                    scrollWidth / this.layout.spreadWidth
                  );
                  ...
                  while (stack.length) {
                    ...
                    found = this.walk($el, function (node) {
                      ...
                      if (_this2.horizontal && _this2.direction === "ltr") {
                        ...
                        _this2.horizontal &&
                        _this2.direction === "rtl"
                      ) {
                        left = Math.round(
                          _this2.horizontal ? elPos.left : elPos.top
                        );
                        right = Math.round(
                          _this2.horizontal ? elPos.right : elPos.bottom
                        );
              ...
              },
              {
                ...
                value: function rangePairToCfiPair(cfiBase, rangePair) {
                  ...
                  var startCfi = new _epubcfi2.default(
                    startRange,
                    cfiBase
                  ).toString();
                  var endCfi = new _epubcfi2.default(
                    endRange,
                    cfiBase
                  ).toString();
              ...
              this.settings = (0, _core.extend)(
                {
                  ignoreClass: "",
                  axis:
                    options.layout && options.layout.props.flow === "scrolled"
                      ? "vertical"
                      : "horizontal",
                  direction: undefined,
                  width: 0,
            ...
            _createClass(IframeView, [
                ...
                value: function render(request, show) {
                  ...
                  return this.sectionRender
                    ...
                    .then(
                      function () {
                        this.emit(
                          _constants.EVENTS.VIEWS.RENDERED,
                          this.section
                        );
                      }.bind(this)
                    );
              ...
              },
              {
                ...
                value: function lock(what, width, height) {
                  ...
                  if (what == "width" && (0, _core.isNumber)(width)) {
                    this.lockedWidth =
                      width - elBorders.width - iframeBorders.width;
                  ...
                  if (
                    what === "both" &&
                    (0, _core.isNumber)(width) &&
                    (0, _core.isNumber)(height)
                  ) {
                    this.lockedWidth =
                      width - elBorders.width - iframeBorders.width;
                    this.lockedHeight =
              ...
              },
              {
                ...
                value: function reframe(width, height) {
                  ...
                  var widthDelta = this.prevBounds
                    ? width - this.prevBounds.width
                    : width;
                  var heightDelta = this.prevBounds
              ...
              },
              {
                ...
                value: function load(contents) {
                  ...
                  if (this.settings.method === "blobUrl") {
                    this.blobUrl = (0, _core.createBlobUrl)(
                      contents,
                      "application/xhtml+xml"
                    );
              ...
              },
              {
                ...
                value: function onLoad(event, promise) {
                  ...
                  this.contents = new _contents2.default(
                    this.document,
                    this.document.body,
                  ...
                  var link = this.document.querySelector(
                    "link[rel='canonical']"
                  );
                  if (link) {
                  ...
                  this.contents.on(
                    _constants.EVENTS.CONTENTS.EXPAND,
                    function () {
                  ...
                  this.contents.on(
                    _constants.EVENTS.CONTENTS.RESIZE,
                    function (e) {
                      if (_this2.displayed && _this2.iframe) {
                        _this2.expand();
                        if (_this2.contents) {
              ...
              },
              {
                ...
                value: function highlight(cfiRange) {
                  ...
                  var m = new _marksPane.Highlight(range, "epubjs-hl", data, {
                    fill: "yellow",
                    "fill-opacity": "0.3",
              ...
              },
              {
                ...
                value: function underline(cfiRange) {
                  ...
                  var m = new _marksPane.Underline(range, "epubjs-ul", data, {
                    stroke: "black",
                    "stroke-opacity": "0.3",
                    "mix-blend-mode": "multiply",
                  });
                  ...
                  if (
                    ...
                    for (var i = 0; i != rects.length; i++) {
                      ...
                      if (!left || rect.left < left) {
                        left = rect.left;
                        right =
                          left + this.layout.columnWidth - this.layout.gap;
                        top = rect.top;
                      }
                    }
                  }
          ...
          var ContinuousViewManager = (function (_DefaultViewManager) {
            ...
            function ContinuousViewManager(options) {
              ...
              var _this = _possibleConstructorReturn(
                this,
                (
                  ContinuousViewManager.__proto__ ||
                  Object.getPrototypeOf(ContinuousViewManager)
                ).call(this, options)
              );
            ...
            _createClass(ContinuousViewManager, [
              {
                key: "display",
                value: function display(section, target) {
                  return _default2.default.prototype.display
   ...
   */
                ...
                value: function update(_offset) {
                  ...
                  for (var i = 0; i < viewsLength; i++) {
                    ...
                    if (isVisible === true) {
                      ...
                      if (!view.displayed) {
                        var displayed = view.display(this.request).then(
                          function (view) {
                            view.show();
                          },
                          function (err) {
                ...
                value: function check(_offsetLeft, _offsetTop) {
                  ...
                  if (newViews.length) {
                    return Promise.all(promises)
                      .then(function () {
                        if (
                          _this5.layout.name === "pre-paginated" &&
                          _this5.layout.props.spread
                        ) {
                          return _this5.check();
                        }
                      })
              ...
              },
              {
                ...
                value: function addScrollListeners() {
                  ...
                  scroller.addEventListener("scroll", this.onScroll.bind(this));
                  this._scrolled = (0, _debounce2.default)(
                    this.scrolled.bind(this),
                    30
                  );
              ...
              },
              {
                ...
                value: function onScroll() {
                  ...
                  this.scrollDeltaVert += Math.abs(
                    scrollTop - this.prevScrollTop
                  );
                  this.scrollDeltaHorz += Math.abs(
                    scrollLeft - this.prevScrollLeft
                  );
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          var Book = (function () {
            function Book(url, options) {
               ...
               * @memberof Book
               */
              this.locations = new _locations2.default(
                this.spine,
                this.load.bind(this)
              );
            ...
            _createClass(Book, [
              {
                ...
                value: function open(input, what) {
                  ...
                  if (type === INPUT_TYPE.BINARY) {
                    ...
                    this.archived = true;
                    this.url = new _url2.default("/", "");
                    opening = this.request(input, "binary").then(
                      this.openEpub.bind(this)
                    );
              ...
              },
              {
                ...
                value: function replacements() {
                  ...
                  this.spine.hooks.serialize.register(function (
                    output,
                    section
                  ) {
                    section.output = _this9.resources.substitute(
                      output,
                      section.url
                    );
                  });
              ...
              },
              {
                ...
                value: function key(identifier) {
                  var ident =
                    identifier ||
                    this.package.metadata.identifier ||
                    this.url.filename;
            ...
            _createClass(Spine, [
              {
                ...
                value: function unpack(_package, resolver, canonical) {
                  ...
                  this.items.forEach(function (item, index) {
                    ...
                    item.index = index;
                    item.cfiBase = _this.epubcfi.generateChapterComponent(
                      _this.spineNodeIndex,
                      item.index,
                      item.idref
                    );
              ...
              },
              {
                key: "each",
                value: function each() {
                  return this.spineItems.forEach.apply(
                    this.spineItems,
                    arguments
                  );
                },
            ...
            _createClass(Section, [
              {
                ...
                value: function load(_request) {
                  var request =
                    _request || this.request || __webpack_require__(11);
                  var loading = new _core.defer();
                  var loaded = loading.promise;
                    ...
                    request(this.url)
                      .then(
                        function (xml) {
                          ...
                          return this.hooks.content.trigger(
                            this.document,
                            this
                          );
                        }.bind(this)
            ...
            _createClass(Container, [
              {
                ...
                value: function parse(containerDocument) {
                  ...
                  this.directory = _pathWebpack2.default.dirname(
                    this.packagePath
                  );
            ...
            _createClass(Packaging, [
              {
                ...
                value: function parse(packageDocument) {
                  ...
                  this.spineNodeIndex = (0, _core.indexOfElementNode)(
                    spineNode
                  );
              ...
              },
              {
                ...
                value: function parseMetadata(xml) {
                  ...
                  metadata.description = this.getElementText(
                    xml,
                    "description"
                  );
                  ...
                  metadata.layout = this.getPropertyText(
                    xml,
                    "rendition:layout"
                  );
                  ...
                  metadata.viewport = this.getPropertyText(
                    xml,
                    "rendition:viewport"
                  );
            ...
            _createClass(Navigation, [
              ...
              },
              {
                ...
                value: function parseNav(navHtml) {
                  var navElement = (0, _core.querySelectorByType)(
                    navHtml,
                    "nav",
                    "toc"
                  );
                  var navItems = navElement
                    ? (0, _core.qsa)(navElement, "li")
                    : [];
              ...
              },
              {
                ...
                value: function navItem(item) {
                  ...
                  while (!parent && parentItem) {
                    parentItem = (0, _core.getParentByTagName)(
                      parentItem,
                      "li"
                    );
                    if (parentItem) {
            ...
            _createClass(Resources, [
              ...
              },
              {
                ...
                value: function replacements() {
                  ...
                  return Promise.all(replacements).then(function (
                    ...
                    _this.replacementUrls = replacementUrls.filter(function (
                      url
                    ) {
              ...
              },
              {
                ...
                value: function createCssFile(href) {
                  ...
                  var relUrls = this.urls.map(function (assetHref) {
                    ...
                    var relative = new _path2.default(absolute).relative(
                      resolved
                    );
                  ...
                  return textResponse.then(
                    function (text) {
                      ...
                      text = (0, _replacements.substitute)(
                        text,
                        relUrls,
                        _this2.replacementUrls
                      );
              ...
              },
              {
                ...
                value: function substitute(content, url) {
                  ...
                  return (0, _replacements.substitute)(
                    content,
                    relUrls,
                    this.replacementUrls
                  );
            ...
            _createClass(PageList, [
              ...
              },
              {
                ...
                value: function pageFromCfi(cfi) {
                  ...
                  var index = (0, _core.indexOfSorted)(
                    cfi,
                    this.locations,
                    this.epubcfi.compare
                  );
          ...
          var Annotations = (function () {
            ...
            _createClass(Annotations, [
              ...
              },
              {
                ...
                value: function remove(cfiRange, type) {
                  ...
                  if (hash in this._annotations) {
                    ...
                    var views = this.rendition.views();
                    views.forEach(function (view) {
                      _this._removeFromAnnotationBySectionIndex(
              ...
              },
              {
                ...
                value: function _removeFromAnnotationBySectionIndex(
                  sectionIndex,
                  hash
                ) {
                  this._annotationsBySectionIndex[sectionIndex] =
                    this._annotationsAt(sectionIndex).filter(function (h) {
                      return h !== hash;
                    });
                },
            ...
            _createClass(Stage, [
              ...
              },
              {
                ...
                value: function onResize(func) {
                  ...
                  if (
                    !(0, _core.isNumber)(this.settings.width) ||
                    !(0, _core.isNumber)(this.settings.height)
                  ) {
              ...
              },
              {
                ...
                value: function size(width, height) {
                  ...
                  this.containerPadding = {
                    ...
                    right:
                      parseFloat(this.containerStyles["padding-right"]) || 0,
                    top: parseFloat(this.containerStyles["padding-top"]) || 0,
                    bottom:
                      parseFloat(this.containerStyles["padding-bottom"]) || 0,
                  };
            ...
            _createClass(Archive, [
              ...
              },
              {
                ...
                value: function openUrl(zipUrl, isBase64) {
                  return (0, _request2.default)(zipUrl, "binary").then(
                    function (data) {
