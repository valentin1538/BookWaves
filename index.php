              ...
              <div class="border-head">
                <h3>BIBLIOTHEQUE COMMUNE</h3>
                  ...
                  try {
                      ...
                      $requete = "SELECT livre.nom AS nom, auteur.nom AS auteur, editeur.nom AS editeur, genre.nom AS genre, langue.nom AS langue, livre.infos AS infos, livre.lienepub AS lienepub 
                          FROM livre 
                  ...
                  foreach ($livres as $livre) {
                      ...
                      echo '<li>';
                      echo '<a href="pages_autres/affichageLivre.php?book=' . urlencode($livre['lienepub']) . '"><i class="fa fa-eye"></i> Visualiser</a>'; // Modification du lien ici
                      echo '</li>';
                      echo '<li>';
                      ...
                      echo '<p><strong>Lien :</strong> ' . $livre['lienepub'] . '</p>';
                      echo '</div>';
                  }
                  echo '</div>';
