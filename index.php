...
if (isset($_SESSION['success_message'])) {
  // Afficher le message de succès comme notification
  echo "<div class='alert alert-success' role='alert'>" . $_SESSION['success_message'] . "</div>";
  
  // Effacer le message de la session pour éviter l'affichage répété
          ...
          <div class="main-chart">
            ...
            <div class="border-head">
              ...
              foreach ($livres as $livre) {
                ...
                echo '<a href="./pages_autres/avis.php?id=' . urlencode($livre['id']) . '"><i class="fa fa-eye"></i> Avis</a>';
                echo '</li>';
                echo '</ul>';
                echo '</div>';
                echo '</div>';
