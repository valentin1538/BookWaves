...
$servername = "localhost"; // le nom de votre serveur de base de données
$username = "root"; // nom d'utilisateur de base de données
$password = ""; // votre mot de passe de base de données
$database = "Biblio"; // le nom de votre base de données
...
session_start();
// Vérifie si l'utilisateur est connecté, sinon redirige-l'utilisateur vers la page de connexion
